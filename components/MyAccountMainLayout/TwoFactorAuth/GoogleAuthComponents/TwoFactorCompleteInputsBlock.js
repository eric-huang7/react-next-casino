...
export const TwoFactorCompleteInputsBlock = ({t, deactivateButtonClickHandler, deactivateCodeValue, deactivateInputHandler, deactivateError}) => {
  ...
  return (
    <div className={styles.deactivateAuthInputsBlock}>
      <p className={styles.deactivateHeading}>{t("myAccount.twoFactorAuthPage.twoFaCompleteContainer.deactivateGoogleAuth")}</p>
      <p className={styles.deactivateInfo}>{t("myAccount.twoFactorAuthPage.twoFaCompleteContainer.enterCurrentAuthCode")}</p>
