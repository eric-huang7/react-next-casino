export const termsAndConditions = {
  data: 'Terms and Conditions\n' +
    ...
    '\n' +
    'The Service is owned by 5 for 5 Media N.V. a limited liability company registered in Curacao with company registration number 155513 (0) with registered address at Abrham de Veerstraat 9, Curacao (“Company”), licensed in Curaçao under the Licence t#PENDING issued by Gaming Services Provider N.V. for the provision of online games of chance.\n' +
    '\n' +
    '2. General Terms\n' +
    '\n' +
    ...
    '\n' +
    '8.2. Fees and charges may apply to customer deposits and withdrawals, which can be found on the Website. In most cases we absorb transaction fees for deposits to your Slotsidol.com. You are responsible for your own bank charges that you may incur due to depositing funds with us.\n' +
    '\n' +
    ...
    '\n' +
    '13.4. From time to time, we may contact you by email for the purpose of offering you information about betting, unique promotional offerings, and other information from Slotsidol.com. You agree to receive such emails when you agree to these Terms when registering at the Website. You can choose to opt out of receiving such promotional offerings from us at any time by submitting a request to the Customer Support.\n' +
    '\n' +
    ...
    'any monies deposited in your Account which are not winnings will be returned to you OR retained until you turn 18 years old at our sole discretion. We reserve the right to deduct payment transaction fees from the amount to return, including transaction fees for deposits to your Slotsidol.com account which we covered.\n' +
  ...
  responsibleGambling: 'Gambling with responsibility\n' +
    'Last updated: 25 November 2020\n' +
    '\n' +
    'Please read this information carefully for your own benefit.\n' +
    '\n' +
    'Slotsidol.com is operated 5 for 5 Media N.V. having its office at Abraham de Veerstraat 9 Willemstad, Curacao, Company Registration number 155513 (0)\n' +
    '\n' +
    'Interpretation\n' +
    '\n' +
    ...
    'Website refers to < Slotsidol.com\n' +
    ...
    '\n' +
    'Helpful hints for responsible gambling at Slotsidol.com\n' +
    '\n' +
  ...
  kycPolicy: 'KYC Policy of 5 for 5 Media N.V.\n' +
    '\n' +
    'Last updated: 25 November 2020\n' +
    '\n' +
    'When a user selects to make total deposits/withdrawals of over $200 inside the Slotsidol.com Platform, then it is compulsory for them to perform a full KYC process.\n' +
    '\n' +
    'During this process, the user will have to input some basic details about themselves and then upload\n' +
    '\n' +
    'A proof of ID (in some cases front and back depending on the doc)\n' +
    ...
    'They cannot deposit more than $200 in total\n' +
    'They cannot withdraw more than $200.\n' +
    ...
    '“Other AML measures”\n' +
    '\n' +
    'If a user has not passed full KYC then they can deposit/withdraw up to $200.\n' +
  ...
  amlPolicy: 'AML POLICY\n' +
    '\n' +
    'AML Policy of 5 for 5 Media N.V.\n' +
    '\n' +
    'Last updated: 26 November 2020\n' +
    '\n' +
    'For Deposits and Withdrawals.\n' +
    '\n' +
    '(AML Anti-Money-Laundering policy of SlotsIdol.com)\n' +
    '\n' +
    'Introduction: SlotsIdol.com is operated by 5 for 5 Media N.V. having its office at Abrham de Veerstraat 9, Curacao. Company Registration number 155513(0)\n' +
    '\n' +
    'Objective of the AML Policy: We seek to offer the highest security to all of our users and customers on SlotsIdol.com for that a three step account verification is done in order to insure the identity of our customers. The reason behind this is to prove that the details of the person registered are correct and the deposit methods used are not stolen or being used by someone else, which is to create the general framework for the fight against money laundering. We also take into accord that depending on the nationality and origin, the way of payment and for withdrawing different safety measurements must be taken.\n' +
    '\n' +
    'SlotsIdol.com also puts reasonable measures in place to control and limit ML risk, including dedicating the appropriate means.\n' +
    '\n' +
    'SlotsIdol.com is committed to high standards of anti-money laundering (AML) according to the EU guidelines, compliance and requires management & employees to enforce these standards in preventing the use of its services for money laundering purposes.\n' +
    '\n' +
    'The AML program of SlotsIdol.com is designed to be compliant with :\n' +
    '\n' +
    ...
    '\n' +
    'Organization of the AML for SlotsIdol.com\n' +
    '\n' +
    'In accordance with the AML legislation SlotsIdol.com has appointed the “highest level” for the prevention of ML: The full management of 5 for 5 Media N.V. are in charge.\n' +
    '\n' +
    ...
    '\n' +
    'Each major change of SlotsIdol.com AML policy is subject to be approval by the general management of 5 for 5 Media N.V and the Anti money laundering compliance officer.\n' +
    '\n' +
    ...
    '\n' +
    'SlotsIdol.com also asks for a bank wire/credit card to further insure the Identity of the user/customer. It also gives additional information about the financial situation of the user/customer.\n' +
    '\n' +
    'Basic document for step one:\n' +
    '\n' +
    'The basic document will be accessible via the setting page on SlotsIdol.com Every user has to fill out the following information’s:\n' +
    '\n' +
    'First name\n' +
    'Second name\n' +
    'Nationality\n' +
    ...
    'Risk management:\n' +
    '\n' +
    'In order to deal with the different risks and different states of wealth in different regions on the earth SlotsIdol.com will categorize every nation in three different regions of risk.\n' +
    '\n' +
    'Region one: Low risk:\n' +
    '\n' +
    ...
    '\n' +
    'In addition, an AI which is overseen by the AML compliance officer will look for any unusual behaviour and report it right away to a employee of SlotsIdol.com.\n' +
    '\n' +
    ...
    '\n' +
    'As part of its risk-based approach, SlotsIdol.com has conducted an AML “Enterprise-wide risk assessment” (EWRA) to identify and understand risks specific to SlotsIdol.com its business lines. The AML risk policy is determined after identifying and documenting the risks inherent to its business lines such as the services the website offers. The Users to whom services are offered, transactions performed by these Users, delivery channels used by the bank, the geographic locations of the bank’s operations, customers and transactions and other qualitative and emerging risks.\n' +
    '\n' +
    'The identification of AML risk categories is based on SlotsIdol.com understanding of regulatory requirements, regulatory expectations and industry guidance. Additional safety measures are taken to take care of the additional risks the world wide web brings with it.\n' +
    '\n' +
    ...
    '\n' +
    'SlotsIdol.com works solely with trusted Payment Service Providers whom all have effective AML policies in place as to prevent the large majority of suspicious deposits onto SlotsIdol.com from taking place without proper execution of KYC procedures onto the potential customer.\n' +
    '\n' +
    '2) The second Line of Control:\n' +
    '\n' +
    'SlotsIdol.com makes its network aware so that any contact with the customer or player or authorized representative must give rise to the exercise of due diligence on transactions on the account concerned. In particular these include:\n' +
    '\n' +
    ...
    'Also, the three-step verification with adjusted risk management should provide all necessary information’s about all costumers of SlotsIdol.com at all time.\n' +
    '\n' +
    ...
    '\n' +
    'Any SlotsIdol.com staff member must inform the AML division of any atypical transactions which they observe and cannot attribute to a lawful activity or source of income known of the customer.\n' +
    '\n' +
    '3) The third Line of Control:\n' +
    '\n' +
    'As a last line of defence against AML SlotsIdol.com do manually checks on all suspicious and higher risk users in order to fully prevent money laundering.\n' +
    '\n' +
    'If fraud or Money Laundering is found the authorities will be informed.\n' +
    '\n' +
    'Reporting of Suspicious transactions on SlotsIdol.com\n' +
    '\n' +
    'In its internal procedures, SlotsIdol.com describes in precise terms, for the attention of its staff members, when it is necessary to report and how to proceed with such reporting.\n' +
    '\n' +
    ...
    'Procedures\n' +
    '\n' +
    'The AML rules, including minimum KYC standards will be translated into operational guidance or procedures that are available on the Intranet site of SlotsIdol.com.\n' +
    '\n' +
    'Record keeping\n' +
    '\n' +
    ...
    'Training:\n' +
    '\n' +
    'SlotsIdol.com human employees will make manual controls on a risk based approve for which they get special training.\n' +
    '\n' +
    ...
    '\n' +
    'The content of this training program has to be established in accordance with the kind of business the trainees are working for and the posts they hold. These sessions are given by an AML-specialist working in 5 for 5 Media N.V. AML team.\n' +
    '\n' +
    'Auditing\n' +
    '\n' +
    ...
    '\n' +
    'SlotsIdol.com will follow all guidelines and rules of the data protection directive (officially Directive 95/46/EC)\n' +
    '\n' +
    'Contact us:\n' +
    '\n' +
    'If you have any questions about our AML and KYC Policy, please contact us:\n' +
    '\n' +
    'By email: support@SlotsIdol.com\n' +
    '\n' +
