...
// import {bgGradient, bgGradientGrey} from "/styles/theme";
import {getTheme} from "../../../../../helpers/theme";

const {bgGradient, bgGradientGrey} = getTheme();
...
export const Footer = ({ userAuth }) => {
  ...
  return (
    <Box
      ...
      pb="0"
    >
      <HStack w="100%" pt="34px" pb="25px" px='11px' alignItems="center" bg="rgba(255, 255, 255, 0.7)">
        <Stack direction="row" alignItems="center" justifyContent="center" w="100%" flexWrap="wrap"
             p={{base: 0, lg: "0 50px"}}>
      ...
      <VStack p={{base: "16px", lg: "45px 0 75px"}} alignItems="center" spacing={0} lineHeight="30px">
        ...
        <HStack flexWrap="wrap" justifyContent="center" spacing={0}>
          <Label>
