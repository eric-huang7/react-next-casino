...
const CardForm = ({serverCardNumberError, userInfo, submitted, onSubmit}) => {
  ...
  return (
    <VStack p="10px 20px 30px" spacing={0}>
      <HStack w="100%" h="54px" justifyContent="flex-start" alignItems="center" bg="primary.300" borderRadius="12px"
              mb="25px" px="20px">
        <Text fontSize={16} fontFamily="Montserrat" color="black" textTransform="capitalize">
