...
import {BonusInfoContainer} from "/components/BonusInfoComponents/BonusInfoContainer";
    ...
    >
      ...
      <Box w={{base: "calc(100% - 70px)", lg: "calc(100% - 70px)"}}>
        ...
        >
          ...
          {canShowInfo && <Text fontSize={14} color="primary.900" fontWeight={400} as="span" textDecoration="underline"
            mr={0} onClick={bonusInfoClickHandler}>
