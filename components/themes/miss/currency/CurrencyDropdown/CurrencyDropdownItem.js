    ...
    <HStack alignItems="center" spacing={0} sx={{cursor: pointer && 'pointer'}} {...props}>
      ...
      <VStack py="0" w="100%" alignItems="start" spacing={0}>
        <HStack alignItems="center" spacing={0}>
          <Text as="div" fontSize="15px" lineHeight="20px" color="text.950" mr={1} minW={45} textAlign="left">
            {abbreviation}
          </Text>
          {!!base && <Box
            ml="5px"
          ...
          >
            <Text as="span" fontSize="13px" lineHeight="15px" color="text.950">
              {base}
            </Text>
          </Box>}
        </HStack>
        <Text as="div" fontSize="14px" lineHeight="14px" color="text.950">
          {name}
        </Text>
      </VStack>
    </HStack>
